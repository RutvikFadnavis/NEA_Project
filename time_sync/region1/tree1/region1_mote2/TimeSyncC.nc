...
#include "printf.h"
 ...
 module TimeSyncC {
  ...
  bool busy = FALSE;
  message_t pkt;
  uint32_t t1=0,t2=0,t3=0,t4=0,nodeid=1112,propogation_delay=0,phase_drift=0,done=0;
    event void Boot.booted() {
    	printf("mote with id 1112 is awake \n");
    ...
    event message_t* Receive.receive(message_t* msg, void* payload, uint8_t len) {
		...
		if (len == sizeof(MotetoMoteMsg)) {
			...
			if(newpkt->t2 == 0 && newpkt->node2send==nodeid){
				...
				printf("mote 1112 for the second time \n");
				...
				t4 = newpkt -> t4;
				printf("I have calculated delays\n");
